 ...
 * Fixed position FAB that opens WhatsApp chat in new tab
 * Positioned to avoid conflicts with sticky product bar and footer on mobile
 */

class WhatsAppFloatingButton extends HTMLElement {
    constructor() {
        super();
